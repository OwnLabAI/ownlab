...
Use when:
- You want OwnLab to run Cursor Agent CLI locally as the agent runtime
...
- OwnLab auto-injects local skills into "~/.cursor/skills" when missing.
- OwnLab auto-adds --yolo unless one of --trust/--yolo/-f is already present in extraArgs.
`;
