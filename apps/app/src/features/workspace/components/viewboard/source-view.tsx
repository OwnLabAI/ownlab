...
function NativeSourceView({
  ...
  if (source.type === 'webpage') {
    return (
      <div className="ownlab-viewboard-scroll flex h-full min-h-0 min-w-0 flex-col overflow-y-auto bg-background text-foreground">
        <div className="sticky top-0 z-10 flex items-center justify-end border-b border-border/60 bg-background px-6 py-5">
        ...
        <div className="min-h-0 min-w-0 flex-1">
          <article className="mx-auto flex w-full max-w-[920px] min-w-0 flex-col px-8 py-14 sm:px-12 sm:py-18">
  ...
  return (
    <div className="ownlab-viewboard-scroll flex h-full min-h-0 min-w-0 flex-col overflow-y-auto">
      <div className="sticky top-0 z-10 flex min-w-0 items-center justify-between gap-3 border-b border-border/60 bg-background px-5 py-4">
