    ...
    <ContextMenu>
      <ContextMenuTrigger asChild>
        <button
          ...
          className={cn(
            'flex h-10 w-full min-w-0 items-center gap-2 overflow-hidden rounded-xl pr-3 text-left outline-none transition-colors focus:ring-1 focus:ring-inset focus:ring-ring/60 hover:bg-accent/60',
